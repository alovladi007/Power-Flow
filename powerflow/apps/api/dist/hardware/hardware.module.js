...
exports.HardwareModule = HardwareModule;
exports.HardwareModule = HardwareModule = __decorate([
    (0, common_1.Module)({
        controllers: [hardware_controller_1.HardwareController],
        providers: [hardware_service_1.HardwareService],
        exports: [hardware_service_1.HardwareService],
    })
], HardwareModule);
